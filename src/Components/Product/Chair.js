  ...
  const getData = () =>{
    ...
    axios.post(baseUrl + "product/get-product",body,config).then((res)=>{
        ...
        data = res?.data?.product.filter((v)=>{
            if(v?.category?._id === "64189ddf75ac0242b4513929"){
                return v
            }
        })
        setData(data)
                ...
                {/* <div>
                 ...
                 <div className='py-4'> 
                            ...
                            <div className='space-y-2 space-x-2'>
                                ...
                                <div className='flex items-center'>
                                    <input type="checkbox" id="cat-1" className='ml-2 text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.min === 0} onClick={()=>setFilterData({...filterData,min:0,max:4999})}/>  
                                    <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'> ₹0 - ₹4,999</label>
                                
                                </div>

                                <div className='flex items-center'>
                                    <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.min === 5000} onClick={()=>setFilterData({...filterData,min:5000,max:9999})}/>  
                                    <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer '>₹5,000 - ₹9,999</label>
                                    
                                </div>

                                <div className='flex items-center'>
                                    <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.min === 10000} onClick={()=>setFilterData({...filterData,min:10000,max:14999})}/>  
                                    <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'>₹10,000 - ₹14,999</label>
                                    
                                </div>

                                <div className='flex items-center'>
                                    <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.min === 15000} onClick={()=>setFilterData({...filterData,min:15000,max:19999})}/>  
                                    <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'>₹15,000 - ₹19,999</label>
                                    
                                </div>
                                <div className='flex items-center'>
                                    <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.min === ""} onClick={()=>setFilterData({...filterData,min:"",max:""})}/>  
...
<div className='py-4'> 
                        ...
                        <div className='space-y-2 space-x-2'>
                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='ml-2 text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.letter === "Arm Chair"} onClick={()=>setFilterData({...filterData,letter:"Arm Chair"})}/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'>Arm Chair</label>
                            
                            </div>

                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.letter === "Bar Chair"} onClick={()=>setFilterData({...filterData,letter:"Bar Chair"})}/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer '> Bar Chair</label>
                                
                            </div>

                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.letter === "Corner Chair"} onClick={()=>setFilterData({...filterData,letter:"Corner Chair"})}/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'>Corner Chair</label>
                                
                            </div>
                            {/* <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer'/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'>Dining Chair</label>
                                
                            </div> */}
                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer'checked={filterData?.letter === "Rocking Chair"} onClick={()=>setFilterData({...filterData,letter:"Rocking Chair"})}/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'>Rocking Chair</label>
                                
                            </div>
                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer'checked={filterData?.letter === ""} onClick={()=>setFilterData({...filterData,letter:""})}/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'>All</label>
...
<div className='col-span-3 grid grid-cols-3 gap-3'>
    {data?.map((val)=>{
        return(
<div className='ml-2' onClick={()=> navigate(`/productdetail/${val?._id}`)}>
                <div class="bg-white shadow rounded overflow-hidden">  
                    <div className='relative'>
                    <div className='min-h-50 aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none lg:h-80'>
                    ...
                    {/* <div className='absolute inset-0 bg-opacity-40 flex justify-end'>
                            <Link className='text-w
                            hite text-lg w-9 h-8 mt-2 mr-2 rounded-full bg-yellow-900 flex items-center justify-center hover:bg-black transition'>
                                <IoHeartOutline/>
                            </Link>
                        </div> */}
                    </div>
