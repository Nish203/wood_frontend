...
<div className='py-4'> 
                        ...
                        <div className='space-y-2 space-x-2'>
                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='ml-2 text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.letter === "Rack"} onClick={()=>setFilterData({...filterData,letter:"Rack"})}/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'>Rack</label>
                            
                            </div>

                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.letter === "Hook & Holder"} onClick={()=>setFilterData({...filterData,letter:"Hook & Holder"})}/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer '> Hook & Holder </label>
                                
                            </div>

                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer'checked={filterData?.letter === "Wall Decor"} onClick={()=>setFilterData({...filterData,letter:"Wall Decor"})}/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'>Wall Decor</label>
                                
                            </div>

                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer'checked={filterData?.letter === "Mirror"} onClick={()=>setFilterData({...filterData,letter:"Mirror"})}/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'>Mirror</label>
