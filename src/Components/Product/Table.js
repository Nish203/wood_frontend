  ...
  const getData = () =>{
    ...
    axios.post(baseUrl + "product/get-product",body,config).then((res)=>{
        ...
        data = res?.data?.product.filter((v)=>{
            if(v?.category?._id === "64189e1675ac0242b451393d"){
                return v
            }
        })
        setData(data)
...
<div className='py-4'> 
                        ...
                        <div className='space-y-2 space-x-2'>
                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='ml-2 text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.letter === "Bar Table"} onClick={()=>setFilterData({...filterData,letter:"Bar Table"})}/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'> Bar Table</label>
                            
                            </div>

                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.letter === "Coffee Table"} onClick={()=>setFilterData({...filterData,letter:"Coffee Table"})}/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer '> Coffee Table</label>
                                
                            </div>

                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.letter === "Dining Table"} onClick={()=>setFilterData({...filterData,letter:"Dining Table"})}/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'>Dining Table</label>
                                
                            </div>

                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.letter === "Console Table"} onClick={()=>setFilterData({...filterData,letter:"Console Table"})}/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'>Console Table</label>
                                
                            </div>

                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.letter === "Study Table"} onClick={()=>setFilterData({...filterData,letter:"Study Table"})}/>  
