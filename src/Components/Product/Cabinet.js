...
<div className='py-4'> 
                        ...
                        <div className='space-y-2 space-x-2'>
                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='ml-2 text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.letter === "Bar Cabinet"} onClick={()=>setFilterData({...filterData,letter:"Bar Cabinet"})}/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'> Bar Cabinet</label>
                            
                            </div>

                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.letter === "Bedsit Cabinet"} onClick={()=>setFilterData({...filterData,letter:"Bedsit Cabinet"})}/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer '>Bedsit Cabinet</label>
                                
                            </div>

                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.letter === "Wall Cabinet"} onClick={()=>setFilterData({...filterData,letter:"Wall Cabinet"})}/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'>Wall Cabinet</label>
                                
                            </div>

                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer' checked={filterData?.letter === "WardRobe"} onClick={()=>setFilterData({...filterData,letter:"WardRobe"})}/>  
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'>WardRobe</label>
