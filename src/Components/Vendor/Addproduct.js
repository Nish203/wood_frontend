    ...
    <div className='sm:ml-72 ml-10 sm:mr-72 mr-10 mb-5'>
        ...
        <div class="md:col-span-2">
                ...
                <div class="md:col-span-5">
                  ...
                  <textarea type="text" name="description" value={newData?.description} onChange={(e)=> handleChange(e)} id="Description" class="h-24 border mt-1 rounded px-4 w-full bg-gray-200" placeholder="" />
                </div>
